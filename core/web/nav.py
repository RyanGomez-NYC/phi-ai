...
NAV: tuple[NavGroup, ...] = (
    ...
    NavGroup("Integration", (
        ...
        NavItem("orch_systems", "", "Connected systems", "/orchestration/systems",
                permissions=("integration:view",)),
        NavItem("orch_links", "", "Patient link set", "/orchestration/links",
                permissions=("integration:view",)),
        NavItem("orch_crosswalk", "", "Practitioner crosswalk", "/orchestration/crosswalk",
                permissions=("integration:view",)),
        NavItem("orch_lattice", "", "Permission lattice", "/orchestration/lattice",
                permissions=("integration:view",)),
        NavItem("orch_holdings", "", "What each system holds", "/orchestration/holdings",
                permissions=("integration:view",)),
